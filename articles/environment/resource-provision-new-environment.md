...
3. 启动映射。 有关详细信息，请参阅 [Project Operations 双重写入映射版本](resource-dual-write-maps.md#project-operations-dual-write-maps)
4. 验证所有项目相关映射是否处于运行状态。
