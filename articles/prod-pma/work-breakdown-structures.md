...
在某些情况下，您可能想要不遵守这些规则。 您可以关闭自动计划编制以防止 Finance 自动设置或更正叶节点任务的任何属性。 如果您为某个任务输入的信息违反任何计划编制规则，则会针对该任务显示一个计划编制错误图标。 如果您不希望显示计划编制错误，请单击 **显示计划编制错误** 以关闭此功能。 
