---
title: 管理项目报价单上的多个客户
description: 本文提供处理将为项目提供资金的多个客户的报价单的信息。  (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
| **字段** | **位置** | **说明** | **下游影响** |
| --- | --- | --- | --- |
| 帐户​​ | **报价单客户** 选项卡上的可编辑网格以及报价单客户的 **主要** 和 **快速创建** 窗体。 | 列出所有活动客户。 此字段在创建记录后将被锁定。 如果要更新，请删除该记录，然后重新创建字段。 如果已记录任何实际值，或者报价单客户记录是主要客户，则不允许您删除此记录。 | 报价单客户在创建报价单明细时作为报价单明细客户复制。 当报价单赢单时，报价单客户还会复制到项目合同客户中。 |
