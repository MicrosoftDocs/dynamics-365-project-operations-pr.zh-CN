...
description: 本文列出了 Project Service Automation 更新版 26 V3 中提供的功能和修补程序。
author: ruhercul
...
本文列出了 Project Service Automation 更新版 26 V3 的新增和更改的功能和修补程序。 此版本的内部版本号为 V3.10.44.59，通过 2020 年 12 月的自动更新公开发布。
