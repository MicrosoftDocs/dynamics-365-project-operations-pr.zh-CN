...
description: 本文提供有关 Project Service Automation 更新版 12 V3 中的新增功能的信息。
author: ruhercul
...
本文列出了 Project Service Automation V3 更新版 12 的新增和更改的功能和修补程序。 该版本的内部版本号为 V3.10.2.34，并且在 2019 年 10 月通过自行更新公开发布。
