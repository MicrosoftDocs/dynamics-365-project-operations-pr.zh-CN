...
description: 本文列出了 Project Service Automation 更新版 20 V3 中提供的功能和修补程序
author: ruhercul
...
本文列出了 Project Service Automation V3 更新版 20 的新增和更改的功能和修补程序。 该版本的内部版本号为 V 3.10.31.37，并且在 2020 年 6 月通过自行更新公开发布。
