...
description: 本文列出了 Project Service Automation 更新版 17.5 V3 中提供的功能和修补程序。
author: ruhercul
...
本文列出了 V3 更新版 17.5 的新增和更改的功能和修补程序。 该版本的内部版本号为 V3.10.7.32，并且在 2020 年 3 月通过自行更新公开发布。
